...
#RsoTable tr.header, #RsoTable tr:hover {
...
<article align = "center">
	  ...
	  <fieldset class="format1">
		  ...
		  Student Organization lookup<br></br>
      	
      	<input type="text" id="myInput" onkeyup="mySearch()" placeholder="Search for names..">

<table id="RsoTable">
  <tr class="header">
    <th style="width:40%;">Name of Student Organization</th>
    <th style="width:30%;">University</th>
    <th style="width:30%;">Date Founded</th>
  </tr>
  <?php
...
<script>
  ...
  table = document.getElementById("RsoTable");
